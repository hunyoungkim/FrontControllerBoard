...
<input type="text" id="name" name="name" value="<c:out value='${boardDTO. name}'/>"/>      </p>      
...
<p>      <label for="pass">비밀번호 <strong class="require">필수</strong></label>
 <input type="password" id="pass" name="pass" required placeholder="비밀번호 입력" size="12">      </p>      
