...
<%--파일 업로드 할 수 있도록 설정한다.--%>
<form action="./BoardAdd.do" method="post" id="joinForm" name="boardform"
...
<input type="password" id="password" name="pass" required placeholder="영문
/숫자 4~8자 이내"/>
 </p>
 <p>
 <label for="subject">제목 <strong class="require">필수</strong></label>
<input type="text" id="subject" name="subject" required placeholder="글의 제목
을 입력하세요."/>
 </p>
 <p>
 <label for="content">내용 <strong class="require">필수</strong></label>
<textarea id="content" name="content" cols="74" rows="15" required placeholder=
"글의 내용을 입력하세요.">
</textarea>
 </p>
 <p>
...
<button type="button" value="button" onclick="location.href='./BoardList.do'" class=
"btnOk">
 목록
</button>
 </div>
